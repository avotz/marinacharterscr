...
var hoverintent = __webpack_require__(4);
__webpack_require__(5);
__webpack_require__(6);
__webpack_require__(7);

var $btnMenu = $('.nav-btn-menu'),
    $menu = document.querySelector('.nav-menu .menu-item-has-children'),
    $body = $('body');

$btnMenu.on('click', function (e) {
    var icon = $btnMenu.find('svg');
...
if (isHome()) {
    var fullpage = __webpack_require__(8);
...
dtFleet.on('click', function (e) {
    $(this).next().slideToggle(200).siblings('.fleet-container-mobile dd').slideUp(200);
});
